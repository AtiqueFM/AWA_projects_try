...
//TSS Sensor calibration (DEPRICATED)
...
//COD sensor calibration
#define FRAM_ADDRESS_TSS_SENSOR_CALIB		FRAM_ADDRESS_COD_SENSOR_CALIB + 90 //Used 48 bytes (90 bytes)
//pH Last 10 calibration
#define FRAM_ADDRESS_PHSENSLASTCALIB_HISTORY	FRAM_ADDRESS_TSS_SENSOR_CALIB + 90 //take 204 bytes (210 BYTES)
